...
//! // use your_crate::{Data, File, Profile};
//!
...
//! impl your_crate::Data for InMemoryData {
...
//!
//! // A simple profile
//! let profile = your_crate::Profile { id: "42".into(), name: "Ada".into(), avatar_b64: None };
